...
<div class="ibox signup-box loginscreen  animated fadeInDown"
					...
					<div class="col-xs-12 col-md-6">
						<div class="form-group">
							<label for="organizationame">Organization Name</label> <input
								type="text" class="form-control" id="organizationame"
								required="" ng-model="user.assocOrgId.organizationName">
						</div>
